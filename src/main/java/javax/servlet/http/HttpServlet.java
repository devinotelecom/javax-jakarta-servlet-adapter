...
public abstract class HttpServlet extends GenericServlet {
	@Serial private static final long serialVersionUID = 8466325577512134784L;
...
class NoBodyOutputStream extends ServletOutputStream {
	...
	public void write (byte[] buf, int offset, int len) throws IOException {
		//if (buf == null) throw new NullPointerException(lStrings.getString("err.io.nullArray"));

		if (offset < 0 || len < 0 || offset + len > buf.length) {
			String msg = lStrings.getString("err.io.indexOutOfBounds");
			msg = MessageFormat.format(msg, offset, len, buf.length);
	...
	@Override public jakarta.servlet.ServletOutputStream unwrap (){ return this; }
	...
	public boolean equals (Object obj) {
		return obj instanceof NoBodyOutputStream;
	}
